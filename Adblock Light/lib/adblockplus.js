  ...
  Downloader.prototype =
  {
    ...
    _download: function(downloadable, redirects)
    {
      ...
      var errorCallback = function errorCallback(error)
      {
        ...
        Cu.reportError("Adblock Light: Downloading URL " + downloadable.url + " failed (" + error + ")\n" + "Download address: " + downloadURL + "\n" + "Channel status: " + channelStatus + "\n" + "Server response: " + responseStatus);
...
require.scopes["filterStorage"] = (function()
{
  ...
  var FilterStorage = exports.FilterStorage =
  {
    ...
    get sourceFile()
    {
      ...
      if (!file)
      {
        Cu.reportError("Adblock Light: Failed to resolve filter file location from extensions.adblockplus.patternsfile preference");
      }
